...
Las habilidades del agente permiten a Daemon Protocol descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
Daemon Protocol busca estas ubicaciones:
...
Para las rutas locales del proyecto, Daemon Protocol sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
Daemon Protocol enumera las habilidades disponibles en la descripción de la herramienta `skill`.
