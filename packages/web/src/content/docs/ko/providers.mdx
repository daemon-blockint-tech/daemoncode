...
1. TUI에서 `/connect` 명령을 실행하고 `Daemon Zen`을 선택한 뒤, [opencode.ai/auth](https://opencode.ai/zen)로 이동합니다.
...
1. TUI에서 `/connect` 명령을 실행하고 `Daemon Protocol Go`를 선택한 뒤 [opencode.ai/auth](https://opencode.ai/zen)로 이동하십시오.
