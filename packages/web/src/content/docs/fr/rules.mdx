...
Pour les utilisateurs migrant depuis Claude Code, Daemon Protocol prend en charge les conventions de fichiers de Claude Code comme solutions de secours :
