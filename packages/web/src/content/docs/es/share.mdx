---
title: Compartir
description: Comparte tus conversaciones Daemon Protocol.
---

La función para compartir de Daemon Protocol te permite crear enlaces públicos a tus conversaciones de Daemon Protocol, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, Daemon Protocol:
...
Daemon Protocol admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, Daemon Protocol usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
