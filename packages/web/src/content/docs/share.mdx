---
title: Share
description: Share your Daemon Protocol conversations.
---

Daemon Protocol's share feature allows you to create public links to your Daemon Protocol conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Daemon Protocol:
...
Daemon Protocol supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Daemon Protocol uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
