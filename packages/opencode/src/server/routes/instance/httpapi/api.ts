...
export const RootHttpApi = HttpApi.make("daemoncode-root")
...
export const InstanceHttpApi = HttpApi.make("daemoncode-instance")
...
export const DaemonCodeHttpApi = HttpApi.make("daemoncode")
