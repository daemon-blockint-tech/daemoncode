...
Daemon Protocol 内置两种 Agent，可用 `Tab` 键快速切换：
...
### 基于 Daemon Protocol 进行开发

如果你在项目名中使用了 “opencode”（如 “opencode-dashboard” 或 “opencode-mobile”），请在 README 里注明该项目不是 Daemon Protocol 团队官方开发，且不存在隶属关系。
