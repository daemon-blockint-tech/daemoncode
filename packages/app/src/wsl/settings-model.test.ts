...
describe("WSL server settings presentation", () => {
  ...
  test("offers install and update only when Daemon Protocol needs attention", () => {
  ...
  test("probes the selected distro before entering the Daemon Protocol step", async () => {
    const calls: string[] = []
