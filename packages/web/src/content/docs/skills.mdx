...
Agent skills let Daemon Protocol discover reusable instructions from your repo or home directory.
...
Daemon Protocol searches these locations:
...
For project-local paths, Daemon Protocol walks up from your current working directory until it reaches the git worktree.
...
Daemon Protocol lists available skills in the `skill` tool description.
