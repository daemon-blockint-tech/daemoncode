---
title: خوادم LSP
description: يتكامل Daemon Protocol مع خوادم LSP لديك.
---

يمكن أن يتكامل Daemon Protocol مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي Daemon Protocol مع عدة خوادم LSP مدمجة للغات الشائعة:
