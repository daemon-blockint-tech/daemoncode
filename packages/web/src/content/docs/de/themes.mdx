...
Mit Daemon Protocol kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Daemon Protocol das `opencode`-Theme.
...
Daemon Protocol liefert mehrere eingebaute Themes mit.
...
- Daemon Protocol optisch ans Terminal anpassen wollen
...
Daemon Protocol unterstuetzt ein flexibles JSON-basiertes Theme-System.
