...
1. Uruchom polecenie `/connect` w TUI, wybierz `Daemon Zen` i przejdź do [opencode.ai/auth](https://opencode.ai/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `Daemon Protocol Go` i przejdź do [opencode.ai/auth](https://opencode.ai/zen).
