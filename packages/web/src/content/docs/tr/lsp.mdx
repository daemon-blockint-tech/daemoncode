...
description: Daemon Protocol, LSP sunucularınızla bütünleşir.
---

Daemon Protocol, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

Daemon Protocol, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
