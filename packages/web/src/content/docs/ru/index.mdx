...
Вы также можете получить двоичный файл в разделе [Releases](https://github.com/daemon-blockint-tech/daemoncode/releases).
...
Если вы новичок в использовании поставщиков LLM, мы рекомендуем использовать [Daemon Zen](/docs/zen).
Это тщательно подобранный список моделей, протестированных и проверенных opencode.

1. Запустите команду `/connect` в TUI, выберите opencode и перейдите по адресу [daemonprotocol.com/auth](https://daemonprotocol.com/auth).
...
Вот [пример диалога](https://daemonprotocol.com/s/4XP1fce5) с opencode.
