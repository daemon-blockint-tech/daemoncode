...
تتيح مهارات الوكيل لـ Daemon Protocol اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
يبحث Daemon Protocol في هذه المواقع:
...
بالنسبة لمسارات المشروع المحلية، يتدرج Daemon Protocol صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
يعرض Daemon Protocol المهارات المتاحة في وصف أداة `skill`.
