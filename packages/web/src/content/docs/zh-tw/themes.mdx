...
透過 Daemon Protocol，您可以從多個內建主題中進行選擇，使用能自動適配終端機主題的主題，或者定義您自己的自訂主題。

預設情況下，Daemon Protocol 使用我們自己的 `opencode` 主題。
...
- 希望 Daemon Protocol 與終端機的外觀保持一致
- 使用了自訂終端機配色方案
...
Daemon Protocol 支援靈活的基於 JSON 的主題系統，讓使用者可以輕鬆建立和自訂主題。
