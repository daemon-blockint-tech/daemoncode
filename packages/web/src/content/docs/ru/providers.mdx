...
1. Запустите команду `/connect` в TUI, выберите `Daemon Zen` и перейдите по адресу [opencode.ai/auth](https://opencode.ai/zen).
...
1. Запустите команду `/connect` в TUI, выберите `Daemon Protocol Go` и перейдите по адресу [opencode.ai/auth](https://opencode.ai/zen).
