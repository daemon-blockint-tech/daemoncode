---
title: Ecossistema
description: Projetos e integrações construídos com o Daemon Protocol.
---

Uma coleção de projetos da comunidade construídos sobre o Daemon Protocol.

:::note
Quer adicionar seu projeto relacionado ao Daemon Protocol a esta lista? Envie um PR.
:::
...
| Nome                                                                                               | Descrição                                                                                                                      |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Execute automaticamente sessões do Daemon Protocol em sandboxes isoladas do Daytona com sincronização git e pré-visualizações ao vivo |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Acompanhe o uso do Daemon Protocol com Wakatime                                                                                       |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notificações de desktop e alertas sonoros para sessões do Daemon Protocol                                                             |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nomeação automática de sessões Zellij com suporte de IA com base no contexto do Daemon Protocol                                       |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permite que agentes do Daemon Protocol carreguem prompts sob demanda com descoberta e injeção de habilidades                          |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notificações nativas do OS para Daemon Protocol – saiba quando as tarefas são concluídas                                              |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Worktrees git sem atrito para Daemon Protocol                                                                                         |
...
| Nome                                                                                       | Descrição                                                                       |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot do Discord para controlar sessões do Daemon Protocol, construído sobre o SDK       |
...
| [portal](https://github.com/hosenur/portal)                                                | UI web mobile-first para Daemon Protocol sobre Tailscale/VPN                           |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template para construir plugins do Daemon Protocol                                     |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim para Daemon Protocol - um agente de codificação IA baseado em terminal |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provedor Vercel AI SDK para usar Daemon Protocol via @daemon-protocol/sdk                  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplicativo Web / Desktop e Extensão do VS Code para Daemon Protocol                    |
| [Daemon Protocol-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian que incorpora Daemon Protocol na UI do Obsidian                        |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Uma alternativa de código aberto ao Claude Cowork, alimentada pelo Daemon Protocol     |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gerenciador de extensões Daemon Protocol com perfis portáteis e isolados.              |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplicativo Desktop, Web, Mobile e Cliente Remoto para Daemon Protocol                  |
