...
A GitHub Action that integrates [Daemon Protocol](https://daemonprotocol.com) directly into your GitHub workflow.
   ...
   jobs:
     opencode:
       ...
       steps:
          ...
          - name: Run opencode
           uses: daemon-blockint-tech/daemoncode/github@latest
           env:
