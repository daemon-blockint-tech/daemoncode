...
يدعم Daemon Protocol متغيرات بيئة الوكيل (proxy) القياسية والشهادات المخصصة لبيئات الشبكات المؤسسية.

---

## الوكيل

يتبع Daemon Protocol متغيرات بيئة الوكيل القياسية.
...
إذا كانت مؤسستك تستخدم سلطات تصديق (CA) مخصصة لاتصالات HTTPS، فقم بإعداد Daemon Protocol ليثق بها.
