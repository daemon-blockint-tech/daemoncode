---
title: LSP Servers
description: Daemon Protocol integrates with your LSP servers.
---

Daemon Protocol can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

Daemon Protocol comes with several built-in LSP servers for popular languages:
