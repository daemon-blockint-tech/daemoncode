...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Daemon Protocol",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Daemon Protocol.",
  ...
  "provider.connect.opencodeZen.line1":
    "Daemon Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Daemon Protocol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Daemon Protocol.",
  ...
  "dialog.server.description": "Bytt hvilken Daemon Protocol-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Daemon Protocol ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Daemon Protocol-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Daemon Protocol ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Daemon Protocol inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Daemon Protocol-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Daemon Protocol",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Daemon Protocol ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Daemon Protocol skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Daemon Protocol er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Daemon Protocol starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Daemon Protocol.",
