export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Daemon Protocol を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Daemon Protocol のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'daemoncode' コマンドを使用してください。",
