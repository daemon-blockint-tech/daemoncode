...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@daemon-protocol/sdk/v2"
      ...
      description={
        {
          opencode: (
            <box gap={1}>
              <text fg={theme.textMuted}>
                Daemon Zen gives you access to all the best coding models at the cheapest prices with a single API
                key.
              </text>
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://daemonprotocol.com/zen</span> to get a key
              </text>
            </box>
          ),
          "opencode-go": (
            <box gap={1}>
              <text fg={theme.textMuted}>
                Daemon Protocol Go is a $10 per month subscription that provides reliable access to popular open coding models
                with generous usage limits.
              </text>
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://daemonprotocol.com/go</span> and enable Daemon Protocol Go
              </text>
            </box>
          ),
