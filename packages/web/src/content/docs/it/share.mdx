---
title: Condivisione
description: Condividi le tue conversazioni Daemon Protocol.
---

La funzione di condivisione di Daemon Protocol ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, Daemon Protocol:
...
Daemon Protocol supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, Daemon Protocol usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
