---
title: LSP Server
description: Daemon Protocol lässt sich in Ihren LSP-Server integrieren.
---

Daemon Protocol kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

Daemon Protocol verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und Daemon Protocol eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer Daemon Protocol-Konfiguration aktivieren und anpassen.
