...
Agentferdigheter lar Daemon Protocol oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Daemon Protocol søker etter disse stedene:
...
For prosjektlokale stier går Daemon Protocol opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
Daemon Protocol viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
