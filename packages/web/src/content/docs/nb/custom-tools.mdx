...
description: Lag verktøy som LLM kan kalle inn Daemon Protocol.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Daemon Protocol sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
