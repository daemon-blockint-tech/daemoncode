...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @opencode-ai/sdk 経由で Daemon Protocol を使用するための Vercel AI SDK プロバイダー     |
