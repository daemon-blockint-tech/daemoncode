...
import { Hash } from "@daemon-protocol/core/util/hash"
...
import { optionalOmitUndefined } from "@daemon-protocol/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@daemon-protocol/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
