...
Daemon Protocol is also available as a desktop application. Download directly from the [releases page](https://github.com/daemon-blockint-tech/daemoncode/releases) or [daemonprotocol.com/download](https://daemonprotocol.com/download).
...
Daemon Protocol includes two built-in agents you can switch between with the `Tab` key.
...
Learn more about [agents](https://daemonprotocol.com/docs/agents).

### Documentation

For more info on how to configure Daemon Protocol, [**head over to our docs**](https://daemonprotocol.com/docs).

### Contributing

If you're interested in contributing to Daemon Protocol, please read our [contributing docs](./CONTRIBUTING.md) before submitting a pull request.

### Building on Daemon Protocol

If you are working on a project that's related to Daemon Protocol and is using "opencode" as part of its name, for example "opencode-dashboard" or "opencode-mobile", please add a note to your README to clarify that it is not built by the Daemon Protocol team and is not affiliated with us in any way.
