---
title: Écosystème
description: Projets et intégrations construits avec Daemon Protocol.
---

Une collection de projets communautaires construits sur Daemon Protocol.

:::note
Vous souhaitez ajouter votre projet lié à Daemon Protocol à cette liste ? Soumettez une PR.
:::
...
| Nom                                                                                                | Description                                                                                                                            |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Exécute automatiquement des sessions Daemon Protocol dans des sandbox Daytona isolées avec synchronisation git et prévisualisations en direct |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Suit l'utilisation d'Daemon Protocol avec Wakatime                                                                                            |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifications de bureau et alertes sonores pour les sessions Daemon Protocol                                                                  |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nommage automatique de session Zellij alimenté par l'IA basé sur le contexte Daemon Protocol                                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permet aux agents Daemon Protocol le chargement différé de prompts à la demande avec découverte et injection de compétences                   |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifications natives de l'OS pour Daemon Protocol – sachez quand les tâches sont terminées                                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Worktrees git sans friction pour Daemon Protocol                                                                                              |
...
| Nom                                                                                        | Description                                                                 |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord pour contrôler les sessions Daemon Protocol, construit sur le SDK      |
...
| [portal](https://github.com/hosenur/portal)                                                | Interface Web mobile-first pour Daemon Protocol via Tailscale/VPN                  |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Modèle pour créer des plugins Daemon Protocol                                      |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Fournisseur Vercel AI SDK pour utiliser Daemon Protocol via @daemon-protocol/sdk       |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Application Web / Bureau et extension VS Code pour Daemon Protocol                 |
| [Daemon Protocol-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian qui intègre Daemon Protocol dans l'interface d'Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Une alternative open-source à Claude Cowork, propulsée par Daemon Protocol         |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestionnaire d'extensions Daemon Protocol avec profils portables et isolés.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Application client Bureau, Web, Mobile et Distante pour Daemon Protocol            |
