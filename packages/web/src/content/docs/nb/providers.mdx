...
1. Kjør kommandoen `/connect` i TUI, velg `Daemon Zen` og gå til [opencode.ai/auth](https://opencode.ai/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `Daemon Protocol Go`, og gå til [opencode.ai/auth](https://opencode.ai/zen).
