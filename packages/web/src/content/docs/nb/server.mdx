---
title: Tjener
description: Samhandle med Daemon Protocol-tjener over HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Kommandoen `opencode serve` kjører en hodeløs HTTP-server som eksponerer et OpenAPI-endepunkt som en Daemon Protocol-klient kan bruke.
...
:::tip
Bruk Daemon Protocol-serveren til å samhandle med Daemon Protocol programmatisk.
:::

Denne arkitekturen lar Daemon Protocol støtte flere klienter og lar deg samhandle med Daemon Protocol programmatisk.

Du kan kjøre `opencode serve` for å starte en frittstående server. Hvis du har
Daemon Protocol TUI kjører, vil `opencode serve` starte en ny server.
...
[`/tui`](#tui) endepunktet kan brukes til å kjøre TUI gjennom serveren. Du kan for eksempel forhåndsutfylle eller kjøre en forespørsel. Dette oppsettet brukes av Daemon Protocol [IDE](/docs/ide) plugins.
