---
title: Server LSP
description: Daemon Protocol si integra con i tuoi server LSP.
---

Daemon Protocol può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

Daemon Protocol include diversi server LSP integrati per linguaggi popolari:
