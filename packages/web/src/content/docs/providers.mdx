...
1. Run the `/connect` command in the TUI, select `Daemon Zen`, and head to [opencode.ai/auth](https://opencode.ai/zen).
...
1. Run the `/connect` command in the TUI, select `Daemon Protocol Go`, and head to [opencode.ai/auth](https://opencode.ai/zen).
