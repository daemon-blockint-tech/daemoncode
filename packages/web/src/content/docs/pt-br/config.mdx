...
O esquema de configuração do servidor/tempo de execução é definido em [**`daemonprotocol.com/config.json`**](https://daemonprotocol.com/config.json).

A configuração do TUI usa [**`daemonprotocol.com/tui.json`**](https://daemonprotocol.com/tui.json).
