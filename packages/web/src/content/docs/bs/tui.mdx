---
title: TUI
description: Korištenje korisničkog interfejsa Daemon Protocol terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Daemon Protocol pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Daemon Protocol pokreće TUI za trenutni direktorij.
...
Kada koristite Daemon Protocol TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Daemon Protocol. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Daemon Protocol. _Aliases_: `/quit`, `/q`
...
- `leader_timeout` - Kontroliše koliko dugo Daemon Protocol čeka nakon leader key. Podrazumijevano je `2000`.
