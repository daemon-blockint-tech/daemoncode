...
Vous pouvez ajouter des commandes personnalisées via la configuration Daemon Protocol ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre Daemon Protocol [config](/docs/config) :
