---
title: LSP serveri
description: Daemon Protocol se integriše sa vašim LSP serverima.
---

Daemon Protocol se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Daemon Protocol dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
