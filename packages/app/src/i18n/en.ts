export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Daemon Protocol",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Daemon Protocol.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Daemon Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "daemonprotocol.com/zen",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Daemon Protocol.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Daemon Protocol.",
  ...
  "dialog.server.description": "Switch which Daemon Protocol server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "Daemon Protocol",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Daemon Protocol...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Daemon Protocol in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Daemon Protocol...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Daemon Protocol in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Daemon Protocol in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Daemon Protocol",
  "wsl.onboarding.opencodeReadyIn": "Daemon Protocol is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Daemon Protocol is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Daemon Protocol in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Daemon Protocol",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Daemon Protocol.",
  ...
  "toast.update.description": "A new version of Daemon Protocol ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Daemon Protocol team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Daemon Protocol does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Daemon Protocol includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Daemon Protocol Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Daemon Protocol server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Daemon Protocol",
  ...
  "settings.general.row.appearance.description": "Customise how Daemon Protocol looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Daemon Protocol follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Daemon Protocol is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Daemon Protocol launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Daemon Protocol.",
