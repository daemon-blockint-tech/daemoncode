---
title: ACP podrška
description: Koristite Daemon Protocol u bilo kojem uređivaču kompatibilnom sa ACP.
---

Daemon Protocol podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili Daemon Protocol putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `opencode acp`.

Naredba pokreće Daemon Protocol kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "Daemon Protocol" agenta u AI Chat agent selektoru.
...
Da koristite Daemon Protocol kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi Daemon Protocol kao ACP chat agenta.
...
Daemon Protocol radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj Daemon Protocol konfiguraciji
