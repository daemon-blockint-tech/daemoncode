---
title: LSP-servere
description: Daemon Protocol integreres med dine LSP-servere.
---

Daemon Protocol kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Daemon Protocol leveres med flere indbyggede LSP-servere til populære sprog:
