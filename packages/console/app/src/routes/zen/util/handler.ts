...
import { and, Database, eq, isNull, lt, or, sql } from "@daemon-protocol/console-core/drizzle/index.js"
import { KeyTable } from "@daemon-protocol/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@daemon-protocol/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@daemon-protocol/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@daemon-protocol/console-core/util/date.js"
import { Identifier } from "@daemon-protocol/console-core/identifier.js"
import { Billing } from "@daemon-protocol/console-core/billing.js"
import { Actor } from "@daemon-protocol/console-core/actor.js"
import { WorkspaceTable } from "@daemon-protocol/console-core/schema/workspace.sql.js"
import { ZenData } from "@daemon-protocol/console-core/model.js"
import { Subscription } from "@daemon-protocol/console-core/subscription.js"
import { BlackData } from "@daemon-protocol/console-core/black.js"
import { UserTable } from "@daemon-protocol/console-core/schema/user.sql.js"
import { ModelTable } from "@daemon-protocol/console-core/schema/model.sql.js"
import { ProviderTable } from "@daemon-protocol/console-core/schema/provider.sql.js"
...
import { LiteData } from "@daemon-protocol/console-core/lite.js"
import { Resource } from "@daemon-protocol/console-resource"
...
export async function handler(
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://daemonprotocol.com/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://daemonprotocol.com/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://daemonprotocol.com/workspace/${authInfo.workspaceID}/members`
