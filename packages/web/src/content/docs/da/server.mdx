...
[`/tui`](#tui) endpointet kan bruges til at køre TUI gennem serveren. Du kan for eksempel forududfylde eller køre en forespørgsel. Denne opsætning bruges af Daemon Protocol [IDE](/docs/ide) plugins.
...
Daemon Protocol-serveren viser følgende API'er.
