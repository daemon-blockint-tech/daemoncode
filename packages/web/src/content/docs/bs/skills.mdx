...
Agent skills omogucavaju Daemon Protocol da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Daemon Protocol pretrazuje ove lokacije:
...
Za projektne lokalne putanje, Daemon Protocol ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
Daemon Protocol navodi dostupne skills u opisu `skill` alata.
