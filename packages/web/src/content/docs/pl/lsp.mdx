---
title: Serwery LSP
description: Daemon Protocol integruje się z serwerami LSP.
---

Daemon Protocol może integrować się z serwerami Language Server Protocol (LSP), aby używać diagnostyki jako informacji zwrotnej dla agenta.

---

## Wbudowane

Daemon Protocol posiada kilka wbudowanych serwerów LSP dla następujących języków:
...
Gdy LSP jest włączony i Daemon Protocol otwiera plik:
...
Możesz włączać i dostosowywać serwery LSP poprzez sekcję `lsp` w konfiguracji Daemon Protocol.
