...
- remove the public in-memory `@daemon-protocol/llm` tool loop after replacing its
...
- decide whether to preserve deprecated `@daemon-protocol/llm` orchestration exports
