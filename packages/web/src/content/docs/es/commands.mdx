...
Puede agregar comandos personalizados a través de la configuración Daemon Protocol o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Daemon Protocol [config](/docs/config):
