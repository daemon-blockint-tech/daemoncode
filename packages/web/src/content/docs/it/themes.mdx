...
Con Daemon Protocol puoi scegliere tra diversi temi integrati, usare un tema che si adatta al tema del tuo terminale oppure definire un tema personalizzato.

Per impostazione predefinita, Daemon Protocol usa il tema `opencode`.
...
Daemon Protocol include diversi temi integrati.
...
- Vuole che Daemon Protocol corrisponda all'aspetto del terminale
...
Daemon Protocol supporta un sistema di temi flessibile basato su JSON che permette di creare e personalizzare temi facilmente.
