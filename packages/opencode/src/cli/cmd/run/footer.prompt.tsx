...
import { normalizePromptContent } from "@daemon-protocol/tui/editor"
...
import { OPENCODE_BASE_MODE, useBindings } from "@daemon-protocol/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Daemon Protocol" } satisfies SlashOption,
    ]
