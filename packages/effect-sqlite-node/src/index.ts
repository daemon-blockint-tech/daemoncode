...
export const TypeId: TypeId = "~@daemon-protocol/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@daemon-protocol/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@daemon-protocol/effect-sqlite-node/NodeSqliteClient")
