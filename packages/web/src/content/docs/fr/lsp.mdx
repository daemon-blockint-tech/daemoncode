---
title: Serveurs LSP
description: Daemon Protocol s'intègre à vos serveurs LSP.
---

Daemon Protocol peut s'intégrer aux serveurs Language Server Protocol (LSP) pour utiliser les diagnostics comme retour pour l'agent.

---

## Serveurs intégrés

Daemon Protocol est livré avec plusieurs serveurs LSP intégrés pour les langages populaires :
