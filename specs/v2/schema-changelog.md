...
- Canonical tagged tool file sources in `@daemon-protocol/llm`.
...
- Spill oversized model-facing tool text into globally unique files under Daemon Protocol's shared tool-output directory.
