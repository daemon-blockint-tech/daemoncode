---
title: TUI
description: استخدام واجهة المستخدم TUI في Daemon Protocol.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Daemon Protocol واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Daemon Protocol إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Daemon Protocol في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Daemon Protocol. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Daemon Protocol. _الأسماء المستعارة_: `/quit`, `/q`
...
- `leader_timeout` - يتحكم في مدة انتظار Daemon Protocol بعد الضغط على leader key. القيمة الافتراضية `2000`.
