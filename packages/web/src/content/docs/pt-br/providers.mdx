...
1. Execute o comando `/connect` no TUI, selecione `Daemon Zen` e acesse [opencode.ai/zen](https://opencode.ai/zen).
...
1. Execute o comando `/connect` no TUI, selecione `Daemon Protocol Go` e acesse [opencode.ai/zen](https://opencode.ai/zen).
