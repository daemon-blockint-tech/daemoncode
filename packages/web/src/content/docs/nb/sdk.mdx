---
title: SDK
description: Typesikker JS-klient for Daemon Protocol-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Daemon Protocol JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere Daemon Protocol programmatisk.
...
Opprett en forekomst av Daemon Protocol:
...
Hvis du allerede har en kjørende forekomst av Daemon Protocol, kan du opprette en klientforekomst for å koble til den:
