...
Możesz także pobrać plik binarny z [Releases](https://github.com/daemon-blockint-tech/daemoncode/releases).
...
Jeśli będziesz korzystać z wielu dostawców LLM, zalecamy skorzystanie z [Daemon Zen](/docs/zen).
Aby uzyskać dostęp do wyselekcjonowanej listy modeli, które zostały zatwierdzone i zweryfikowane przez zespół opencode.

1. Uruchom polecenie `/connect` w TUI, wybierz opencode i przejdź do [daemonprotocol.com/auth](https://daemonprotocol.com/auth).
...
Oto [przykładowa rozmowa](https://daemonprotocol.com/s/4XP1fce5) z opencode.
