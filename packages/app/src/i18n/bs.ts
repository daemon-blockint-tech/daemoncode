export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Daemon Protocol",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Daemon Protocol-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Daemon Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Daemon Protocol-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Daemon Protocol-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Daemon Protocol server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Daemon Protocol-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Daemon Protocol timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Daemon Protocol još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Daemon Protocol uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Daemon Protocol server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Daemon Protocol-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Daemon Protocol izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Daemon Protocol prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Daemon Protocol-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Daemon Protocol pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Daemon Protocol-a.",
