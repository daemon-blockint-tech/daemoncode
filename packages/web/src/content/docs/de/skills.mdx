...
Agent Skills erlauben Daemon Protocol, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
Daemon Protocol sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft Daemon Protocol vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
Daemon Protocol listet verfuegbare Skills in der Beschreibung des `skill`-Tools.
