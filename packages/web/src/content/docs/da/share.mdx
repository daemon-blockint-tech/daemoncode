---
title: Deling
description: Del dine Daemon Protocol-samtaler.
---

Daemon Protocol's delingsfunksjon lar deg lage offentlige lenker til dine Daemon Protocol-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, Daemon Protocol:
...
Daemon Protocol støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger Daemon Protocol manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
