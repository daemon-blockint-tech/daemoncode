...
Файл конфигурации имеет схему, определенную в [**`daemonprotocol.com/config.json`**](https://daemonprotocol.com/config.json).

Конфигурация TUI использует [**`daemonprotocol.com/tui.json`**](https://daemonprotocol.com/tui.json).
