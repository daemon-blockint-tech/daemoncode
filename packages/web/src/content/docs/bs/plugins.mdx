---
title: Dodaci
description: Napišite vlastite dodatke za proširenje Daemon Protocol.
---

Dodaci vam omogućavaju da proširite Daemon Protocol spajanjem na različite događaje i prilagođavanjem ponašanja. Možete kreirati dodatke za dodavanje novih funkcija, integraciju sa eksternim uslugama ili izmenu zadanog ponašanja Daemon Protocol.
...
Daemon Protocol pokreće `bun install` pri pokretanju da ih instalira. Vaši dodaci i alati ih zatim mogu uvesti.
...
Evo nekoliko primjera dodataka koje možete koristiti za proširenje Daemon Protocol.
...
Nivoi su: `debug`, `info`, `warn`, `error`. Pogledajte [SDK dokumentaciju](https://daemonprotocol.com/docs/sdk) za detalje.
