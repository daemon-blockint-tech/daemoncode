...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/daemon-blockint-tech/daemoncode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for daemon-blockint-tech/daemoncode...\n")
...
console.log("Fetching npm all-time downloads for daemoncode...\n")
const npmDownloads = await fetchNpmDownloads("daemoncode")
