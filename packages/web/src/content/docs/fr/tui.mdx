---
title: TUI
description: Utilisation de l’interface utilisateur du terminal Daemon Protocol.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Daemon Protocol fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de Daemon Protocol démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le Daemon Protocol TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à Daemon Protocol. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
Quittez Daemon Protocol. *Alias* : `/quit`, `/q`
...
- `leader_timeout` - Contrôle la durée pendant laquelle Daemon Protocol attend après la leader key. Valeur par défaut : `2000`.
