...
beforeAll(async () => {
  ...
  mock.module("@daemon-protocol/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@daemon-protocol/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@daemon-protocol/ui/icon", () => ({ Icon: () => null }))
  mock.module("@daemon-protocol/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
