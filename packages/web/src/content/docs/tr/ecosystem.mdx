...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @opencode-ai/sdk aracılığıyla Daemon Protocol kullanmak için Vercel AI SDK sağlayıcısı |
