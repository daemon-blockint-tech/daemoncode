...
import { ResizeHandle } from "@daemon-protocol/ui/resize-handle"
import { Button } from "@daemon-protocol/ui/button"
import { IconButton } from "@daemon-protocol/ui/icon-button"
import { Tooltip } from "@daemon-protocol/ui/tooltip"
...
import { Session, type Message } from "@daemon-protocol/sdk/v2/client"
...
import { toaster } from "@daemon-protocol/ui/toast"
...
import { useTheme, type ColorScheme } from "@daemon-protocol/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://daemonprotocol.com/desktop-feedback")}
      renderPanel={() =>
