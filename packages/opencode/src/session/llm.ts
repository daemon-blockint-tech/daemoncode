...
import { llmClient } from "@daemon-protocol/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@daemon-protocol/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@daemon-protocol/llm/route"
import type { LLMClientService } from "@daemon-protocol/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @daemon-protocol/llm. It
