import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@daemon-protocol/llm"
...
// Move this extraction into @daemon-protocol/llm when Copilot is handled by the native runtime.
