---
title: TUI
description: Brug af Daemon Protocol-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Daemon Protocol giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Daemon Protocol starter TUI for den nuværende mappe.
...
Når du bruger Daemon Protocol TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Daemon Protocol. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Daemon Protocol. _Aliaser_: `/quit`, `/q`
...
- `leader_timeout` - Styrer hvor længe Daemon Protocol venter efter leader key. Standard er `2000`.
