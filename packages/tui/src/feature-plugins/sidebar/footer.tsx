import type { TuiPlugin, TuiPluginApi } from "@daemon-protocol/plugin/tui"
      ...
      <Show when={show()}>
        ...
        >
          ...
          <box flexGrow={1} gap={1}>
            ...
            <text fg={theme().textMuted}>Daemon Protocol includes free models so you can start immediately.</text>
