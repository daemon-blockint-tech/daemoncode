export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Daemon Protocol",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Daemon Protocol، هل ترغب في تثبيته وإعادة تشغيله؟",
