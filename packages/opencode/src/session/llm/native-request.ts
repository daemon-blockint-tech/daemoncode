import type { JsonSchema, LLMRequest, ProviderMetadata } from "@daemon-protocol/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@daemon-protocol/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @daemon-protocol/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
