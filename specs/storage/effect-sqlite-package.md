...
- `@daemon-protocol/effect-drizzle-sqlite`
...
1. Add `@daemon-protocol/effect-drizzle-sqlite` with a minimal in-memory/file SQLite test schema.
...
4. Add `@daemon-protocol/effect-drizzle-sqlite` as a dependency of `packages/opencode`.
