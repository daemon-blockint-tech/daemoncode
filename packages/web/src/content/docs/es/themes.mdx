...
Con Daemon Protocol puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Daemon Protocol usa nuestro propio tema `opencode`.
...
Daemon Protocol viene con varios temas integrados.
...
- Quiere que Daemon Protocol coincida con la apariencia de su terminal
...
Daemon Protocol admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
