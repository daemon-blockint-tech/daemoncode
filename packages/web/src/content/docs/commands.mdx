...
You can add custom commands through the Daemon Protocol config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Daemon Protocol [config](/docs/config):
