---
title: Ecosistema
description: Proyectos e integraciones construidas con Daemon Protocol.
---

Una colección de proyectos comunitarios construidos en Daemon Protocol.

:::note
¿Quieres agregar tu proyecto relacionado con Daemon Protocol a esta lista? Envíe un PR.
:::
...
| Nombre                                                                                             | Descripción                                                                                                                 |
| -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Ejecute automáticamente sesiones Daemon Protocol en entornos sandbox aislados de Daytona con git sync y vistas previas en vivo     |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Seguimiento del uso de Daemon Protocol con Wakatime                                                                                |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notificaciones de escritorio y alertas sonoras para sesiones Daemon Protocol                                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nomenclatura automática de sesiones Zellij impulsada por IA basada en el contexto Daemon Protocol                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permitir que los agentes Daemon Protocol carguen mensajes de forma diferida a pedido con descubrimiento e inyección de habilidades |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notificaciones nativas del sistema operativo para Daemon Protocol: sepa cuándo se completan las tareas                             |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Árboles de trabajo de Git de fricción cero para Daemon Protocol                                                                    |
...
| Nombre                                                                                     | Descripción                                                                          |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot de Discord para controlar sesiones Daemon Protocol, basado en el SDK                    |
...
| [portal](https://github.com/hosenur/portal)                                                | Interfaz de usuario web móvil para Daemon Protocol a través de Tailscale/VPN                |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Plantilla para crear complementos Daemon Protocol                                           |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Proveedor Vercel AI SDK para usar Daemon Protocol a través de @daemon-protocol/sdk              |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplicación web/de escritorio y extensión VS Code para Daemon Protocol                       |
| [Daemon Protocol-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Complemento de Obsidian que incorpora Daemon Protocol en la interfaz de usuario de Obsidian |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Una alternativa de código abierto a Claude Cowork, impulsada por Daemon Protocol            |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Administrador de extensiones Daemon Protocol con perfiles portátiles y aislados.            |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplicación de escritorio, web, móvil y de cliente remoto para Daemon Protocol               |
