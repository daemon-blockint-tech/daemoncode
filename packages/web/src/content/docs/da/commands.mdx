...
Du kan tilføje brugerdefinerede kommandoer gennem Daemon Protocol-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Daemon Protocol [config](/docs/config):
