...
Med Daemon Protocol kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger Daemon Protocol vårt eget `opencode`-tema.
...
Daemon Protocol kommer med flere innebygde temaer.
...
- Vil at Daemon Protocol skal matche terminalens utseende
...
Daemon Protocol støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.
