...
With Daemon Protocol you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, Daemon Protocol uses our own `opencode` theme.
...
Daemon Protocol comes with several built-in themes.
...
- Want Daemon Protocol to match their terminal's appearance
...
Daemon Protocol supports a flexible JSON-based theme system that allows users to create and customize themes easily.
