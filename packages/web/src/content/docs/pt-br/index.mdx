...
Você também pode baixar o binário na seção [Releases](https://github.com/daemon-blockint-tech/daemoncode/releases).
...
Se você é novo no uso de provedores de LLM, recomendamos usar o [Daemon Zen](/docs/zen).
É uma lista selecionada de modelos que foram testados e verificados pela equipe do opencode.

1. Execute o comando `/connect` no TUI, selecione opencode e acesse [daemonprotocol.com/auth](https://daemonprotocol.com/auth).
...
Aqui está uma [conversa de exemplo](https://daemonprotocol.com/s/4XP1fce5) com o opencode.
