...
通过 Daemon Protocol，您可以从多个内置主题中进行选择，使用能自动适配终端主题的主题，或者定义您自己的自定义主题。

默认情况下，Daemon Protocol 使用我们自己的 `opencode` 主题。
...
Daemon Protocol 支持灵活的基于 JSON 的主题系统，让用户可以轻松创建和自定义主题。
