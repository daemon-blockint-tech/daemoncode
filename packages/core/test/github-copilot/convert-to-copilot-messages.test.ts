import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@daemon-protocol/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
