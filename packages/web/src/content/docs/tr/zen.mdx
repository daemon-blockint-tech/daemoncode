...
Daemon Zen, Daemon Protocol ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Daemon Protocol'daki diğer sağlayıcılar gibi çalışır. Daemon Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Daemon Protocol kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Daemon Protocol ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Daemon Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Daemon Zen, Daemon Protocol'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Daemon Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Daemon Zen'i seçin ve API anahtarınızı yapıştırın.
...
Daemon Protocol yapılandırmanızdaki [model id](/docs/config/#models) `opencode/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `opencode/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Daemon Protocol'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Daemon Protocol'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Daemon Protocol'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Daemon Protocol'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Daemon Protocol'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Daemon Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Daemon Protocol ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
