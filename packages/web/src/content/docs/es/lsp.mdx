...
description: Daemon Protocol se integra con sus servidores LSP.
---

Daemon Protocol puede integrarse con servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para el agente.

---

## Incorporados

Daemon Protocol viene con varios servidores LSP integrados para idiomas populares:
