...
Daemon Zen é uma lista de modelos fornecidos pela equipe do opencode que foram testados e verificados para funcionar bem com o opencode. [Saiba mais](/docs/zen).

:::tip
Se você é novo, recomendamos começar com o Daemon Zen.
:::

1. Execute o comando `/connect` no TUI, selecione `Daemon Zen` e acesse [daemonprotocol.com/zen](https://daemonprotocol.com/zen).
...
Daemon Protocol Go é um plano de assinatura de baixo custo que fornece acesso confiável a modelos de codificação abertos populares fornecidos pela equipe do opencode que foram
testados e verificados para funcionar bem com o opencode.

1. Execute o comando `/connect` no TUI, selecione `Daemon Protocol Go` e acesse [daemonprotocol.com/zen](https://daemonprotocol.com/zen).
...
2. Escolha seu método de autenticação:
   ...
   3. Nome: `Daemon Protocol`, Escopos: `api`
...
Daemon Zen é uma lista de modelos testados e verificados fornecidos pela equipe do opencode. [Saiba mais](/docs/zen).

1. Faça login em **<a href={console}>Daemon Zen</a>** e clique em **Criar Chave da API**.

2. Execute o comando `/connect` e procure por **Daemon Zen**.
