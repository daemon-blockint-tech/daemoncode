...
```
REGISTRY=ghcr.io/daemon-blockint-tech TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/daemon-blockint-tech TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/daemon-blockint-tech/build/bun-node:24.04
```
