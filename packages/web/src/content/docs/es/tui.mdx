---
title: TUI
description: Usando la interfaz de usuario del terminal Daemon Protocol.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Daemon Protocol proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Daemon Protocol se inicia TUI para el directorio actual.
...
Cuando utilice Daemon Protocol TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Daemon Protocol. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Daemon Protocol. _Alias_: `/quit`, `/q`
...
- `leader_timeout`: controla cuánto tiempo espera Daemon Protocol después de la leader key. El valor predeterminado es `2000`.
