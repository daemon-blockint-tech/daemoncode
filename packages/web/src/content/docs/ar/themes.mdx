...
مع Daemon Protocol يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم Daemon Protocol سمتنا `opencode`.
...
يأتي Daemon Protocol مع عدة سمات مدمجة.
...
- يريدون أن يطابق Daemon Protocol مظهر terminal لديهم
...
يدعم Daemon Protocol نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
