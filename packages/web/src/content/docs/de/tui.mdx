---
title: TUI
description: Arbeite mit Daemon Protocol in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Daemon Protocol bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Daemon Protocol die TUI im aktuellen Verzeichnis.
...
In der Daemon Protocol-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu Daemon Protocol hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet Daemon Protocol. _Aliase_: `/quit`, `/q`
...
- `leader_timeout` - Steuert, wie lange Daemon Protocol nach der leader key wartet. Standard ist `2000`.
