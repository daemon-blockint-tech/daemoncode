...
Delingsfunksjonen i Daemon Protocol lar deg lage offentlige lenker til dine Daemon Protocol-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Som standard bruker Daemon Protocol manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
