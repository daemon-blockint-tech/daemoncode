...
Les compétences d'agent permettent à Daemon Protocol de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
Daemon Protocol recherche ces emplacements :
...
Pour les chemins locaux du projet, Daemon Protocol remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
Daemon Protocol répertorie les compétences disponibles dans la description de l'outil `skill`.
