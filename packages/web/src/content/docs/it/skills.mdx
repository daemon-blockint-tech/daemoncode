...
Le skill degli agenti permettono a Daemon Protocol di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
Daemon Protocol cerca in queste posizioni:
...
Per i percorsi locali al progetto, Daemon Protocol risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
Daemon Protocol elenca le skill disponibili nella descrizione dello strumento `skill`.
